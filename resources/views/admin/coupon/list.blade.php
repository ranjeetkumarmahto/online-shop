              ...
              @if ($discountCoupons->isNotEmpty())
                  @foreach ($discountCoupons as $discountCoupon)
                    <tr>
                      ...
                      <th>{{(!empty($discountCoupon->starts_at)) ? \Carbon\Carbon::parse($discountCoupon->starts_at)->format('Y/m/d H:i:s') : '' }}</th>
                      <th>{{(!empty($discountCoupon->expires_at)) ? \Carbon\Carbon::parse($discountCoupon->expires_at)->format('Y/m/d H:i:s') : '' }}</th>
                      <td>
